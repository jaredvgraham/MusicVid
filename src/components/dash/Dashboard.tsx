        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <div className="mt-2 inline-flex items-center gap-2 text-xs text-neutral-400">
                    <span className="rounded-md border border-white/10 bg-white/5 px-2 py-0.5">{projectCount} projects</span>
                </div>
            </div>
            ...
            <div className="flex w-full flex-col items-stretch gap-2 sm:w-auto sm:flex-row sm:items-center">
                ...
                <div className="flex gap-2">
                    ...
                    >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={isRefreshing ? 'animate-spin opacity-80' : 'opacity-80'}>
    ...
    return (
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {Array.from({ length: 6 }).map((_, idx) => (
                <div key={idx} className="overflow-hidden rounded-xl border border-white/10 bg-neutral-900/50 p-4">
    ...
    return (
        <div className="mt-12 grid place-items-center rounded-2xl border border-white/10 bg-neutral-900/40 p-10 text-center">
            <div className="mx-auto max-w-md">
                ...
                <h2 className="mt-4 text-lg font-semibold text-white">{hasProjects ? 'No matches' : 'No projects yet'}</h2>
                <p className="mt-1 text-sm text-neutral-400">
                    {hasProjects
